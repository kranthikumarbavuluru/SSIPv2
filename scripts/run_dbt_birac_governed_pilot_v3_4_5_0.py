...
from services.dbt_birac_governed_pilot_v3_4_5_0 import DBTBIRACGovernedPilot, PipelinePaths, load_config
...
def main() -> int:
    ...
    result = DBTBIRACGovernedPilot(paths, load_config(paths.config_path)).run(live_network=args.live_network)
